...
class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: const Color.fromARGB(255, 166, 0, 255).withAlpha(100),
    primary: const Color.fromARGB(255, 166, 0, 255),
    primaryLight: const Color.fromARGB(255, 166, 0, 255).withAlpha(100),
